...
NATIVE_PATHS = (
    ...
    'tests/test_reduced_a_source_materialization.py',
    'tests/test_hdiv_response_contract.py',
    ...
    "src/radia/__init__.py", "src/radia/_preconditioners.py",
    "CMakeLists.txt", "Build.ps1", "tools/run_test_tier.py",

...
Run::
    ...
    pytest validation_test/panels/test_em_golden.py -v -m slow
    ...
    if missing:
        pytest.skip(
            ...
            + f"\nRegenerate the .vol via Cubit batch using {jou}"
              ...
              f" see validation_test/panels/golden/em_sample_mu1000.json"
...
def test_em_panel_rejects_step_coil_input():
    ...
    real_step = os.path.join(ROOT, "src", "radia", "panels", "samples", "em",

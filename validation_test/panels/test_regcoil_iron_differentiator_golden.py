...
cannot see magnetic material.  The maintained DtN-spectrum validation
`validation_test/kelvin_dtn_spectrum/act8_03_general_iron_design.py` scenario B
shows why that is a real limit: with

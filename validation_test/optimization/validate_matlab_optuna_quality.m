...
multiSamplers = ["random", "tpe", "nsgaii"];
multi = struct();
...
qualityGates = struct( ...
    ...
    "correlated_cmaes_beats_random", ...
        ...
        single.correlated_valley_random.median_regret, ...
    "multiobjective_tpe_front_error_beats_random", ...
        multi.tpe.median_front_error < ...
        multi.random.median_front_error, ...
    "multiobjective_tpe_coverage_exceeds_half_domain", ...
        multi.tpe.median_f1_coverage > 0.5);
...
switch name
    case "random"
        sampler = radia.optuna.RandomSampler(seed);
    case "tpe"
        sampler = radia.optuna.TPESampler(Seed=seed, NStartupTrials=20);
    case "nsgaii"

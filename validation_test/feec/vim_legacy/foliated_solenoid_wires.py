...
scalar, validation_test/feec/vim_legacy/foliated_clebsch_solenoid.py) into WINDABLE DISCRETE
...
Run:  python validation_test/feec/vim_legacy/foliated_solenoid_wires.py
"""
import os
import sys
import math

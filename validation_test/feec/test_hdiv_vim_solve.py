...
def test_minres_iters_bounded_vs_mu_r_distorted():
    ...
    HDiv advantage over hand-crafted surface-charge combinatorial +/-1 loops, which are field-null ONLY on affine
    hexes and carry field on distorted ones.  Here the iters even DECREASE with mu_r

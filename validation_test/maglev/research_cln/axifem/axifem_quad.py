"""
axifem_quad.py — Phase 1b: FEMM/Henrotte Q1 axisymmetric on axis-aligned rectangles.
...
We solve for V_j = A_phi at node j (same convention as Triangle P1 axifem).

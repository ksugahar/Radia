...
| 2026-08-06 | v4.95.47 release 後、radia + cubit-mesh-export + radia-mcp の 3 つ全部が **release-qud クローン** (`S:\Radia\release-qud\Radia-v4.95.47-<sha>`) に drift(新パターン: CI runner ではなく release-qud のリリース用クローンで editable install が走った) | release 直後の本チェックで発覚、即修復 |

#!/usr/bin/env python
"""Restore original simple version and add B-field convergence."""
...
# Current LU-matching version (broken)
old_code = '''					// FIX (2025-12-22): Match LU solver chi update exactly
...
if old_code in content:
    ...
    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)
    print('Restored original simple chi update')
else:
    print('Old code not found - checking current state')
    if 'FIX (2025-12-21): Update NewFieldArray' in content:

...
Run:
    ...
    python examples/build123d_netgen_gmsh_flow/validation_build123d_cubit_pressure_moment.py
    python examples/build123d_netgen_gmsh_flow/validation_build123d_cubit_pressure_moment.py --vol C:\\temp\\box.vol
"""

...
Compares per-stage R_2k, L_{2k+1}, tau_pair from four independent paradigms:
  ...
  (B) axihenrotte FE Q2 + Hiruma 3-term  (NGSolve add-on, differential, axisym)
      Source: S:/.../validation_test/axifem/research/verification/test_hiruma_disk_q2_results.json

  (C) axihenrotte FE Q1 + Hiruma 3-term  (same FE solver, p=1 — convergence check)
      Source: S:/.../validation_test/axifem/research/verification/test_hiruma_disk_q1_results.json
...
Q2_JSON = Path("S:/Radia/01_GitHub/validation_test/axifem/research/verification/"
                "test_hiruma_disk_q2_results.json")
Q1_JSON = Path("S:/Radia/01_GitHub/validation_test/axifem/research/verification/"

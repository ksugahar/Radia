...
DOF basis (matching axifem_quad_q2.py axis-aligned case):
...
Node ordering (matches axifem_quad_q2.py and standard FEMM Q2 layout):
    0: ( -1, -1 ) corner
    1: ( +1, -1 ) corner
    2: ( +1, +1 ) corner
    3: ( -1, +1 ) corner
...
def make_axis_aligned_q2_curved(ra, rb, za, zb, mid_r="quad"):
    ...
    along r:
        "quad":  rm = sqrt((ra^2 + rb^2) / 2)   (matches axifem_quad_q2.py)
    ...
    return AxifemQuadQ2Curved(rn, zn)

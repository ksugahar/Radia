...
spirit). P1 axifem comparison is deferred to Phase B2 (C++ port) because
the existing axifem-core P1 uses a different DOF convention (FEMM V_j
...
# Reuse the P1 element matrices from axifem_core.

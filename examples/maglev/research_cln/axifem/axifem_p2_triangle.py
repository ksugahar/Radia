"""axifem_p2_triangle.py — P2 Henrotte triangle reference (Python).

P2 quadratic triangle in physical (r, z) using the FEMM-Henrotte
convention (matches axifem_core.py P1 implementation):
...
def _make_test_triangle(r0, z0, r1, z1, r2, z2):
    """Return AxifemP2Triangle with straight-edge mid-side nodes."""
...
def main():
    print("=" * 60)
    print("axifem P2 Henrotte triangle Python reference — smoke tests")
    print("=" * 60)

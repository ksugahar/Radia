...
cubit.cmd('radia_export nastran "cube_3d.bdf" dimension 3 overwrite')
...
cubit.cmd('radia_export nastran "plate_2d.bdf" dimension 2 overwrite')
...
cubit.cmd('radia_export nastran "mixed_with_pyramid.bdf" dimension 3 overwrite')
...
cubit.cmd('radia_export nastran "mixed_for_jmag.bdf" dimension 3 nopyramid overwrite')

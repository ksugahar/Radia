#!/usr/bin/env python
"""
Verify ELF vs Radia for the full model (52 hexahedral elements).
...
if not os.path.isdir(ELF_FULL):
    print(f"Skipping: ELF reference data not found at {ELF_FULL}")
    sys.exit(0)
...
elf_B = load_elf_field_at_origin(ELF_FULL)
...
# Create new model with racetrack coil
rad.UtiDelAll()

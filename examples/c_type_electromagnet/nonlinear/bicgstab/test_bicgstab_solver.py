#!/usr/bin/env python
"""
Test BiCGSTAB solver (Method 1) for nonlinear electromagnet.

BiCGSTAB solver: Iterative Bi-Conjugate Gradient Stabilized with Jacobi preconditioner.
- Best for medium problems (500 < N < 2000 elements)
- Faster than LU for large problems
- Memory: O(N) (sparse operations)
"""
...
def main():
    print("=" * 70)
    print("Nonlinear Electromagnet - BiCGSTAB Solver (Method 1)")
    print("=" * 70)
    ...
    # Solve with BiCGSTAB solver
    print("\n" + "-" * 50)
    print("Solving with BiCGSTAB solver (Method 1)...")
    print("-" * 50)
    ...
    print("\n" + "=" * 70)
    print("BiCGSTAB Solver Test Complete")
    print("=" * 70)

#!/usr/bin/env python
"""
Verify ELF vs Radia for nonlinear electromagnet - HACApK solver.
...
print("=" * 70)
print("ELF vs Radia Nonlinear Electromagnet - HACApK Solver")
print("=" * 70)
print("Solver:   HACApK (Method 2)")
...
# Solve with HACApK
print("\n" + "-" * 70)
print("Solving with HACApK (Method 2) - NO IMA")
print("-" * 70)

t_start = time.time()
result = rad.Solve(model, 0.0001, 1000, 2)  # Method 2 = HACApK

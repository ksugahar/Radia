#!/usr/bin/env python
"""
Benchmark: 6x6x6 C-type electromagnet with LU and HACApK solvers.

Compares LU, HACApK on EIEM2 6x6x6 mesh (1200 elements, 7200 DOF).
...
# ============================================================
print("=" * 70)
print("Benchmark: 6x6x6 C-type Electromagnet (Nonlinear 20000 AT)")
print("=" * 70)

# Load geometry
nodes, hex_elements = load_elf_geometry(ELF_6x6x6)
print(f"Mesh: 6x6x6 EIEM2")
...
# Summary
print(f"\n{'='*70}")
print("SUMMARY: 6x6x6 C-type Electromagnet (1200 elem, 7200 DOF)")
print(f"{'='*70}")

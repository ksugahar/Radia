...
def main():
    ...
    out = {"method": "HCurl + Kelvin Kameari iteration (v17: no penalty + Helmholtz-Hodge)",
    ...
    out_path = Path(__file__).parent / "cuboid_521_kameari_kelvin_v17_helmholtz_hodge.json"

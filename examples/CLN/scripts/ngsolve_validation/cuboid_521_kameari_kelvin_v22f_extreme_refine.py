...
print("Starting v22f (extreme refinement test) (refined mesh + Order=3)...", flush=True)
...
z_offset = 5 * a_kelvin
maxh = 0.5e-3      # v22f: extreme refine air (2mm -> 0.5mm)
maxh_disk = 0.05e-3  # extreme refine disk (0.1mm -> 0.05mm)
ORDER = 3
N_STAGES = 6
B0 = 1.0
...
def main():
    ...
    out_path = Path(__file__).parent / "cuboid_521_kameari_kelvin_v22f_extreme_refine.json"

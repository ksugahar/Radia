"""coil_levitation_equilibrium.py -- AC magnetic levitation equilibrium of a
...
This composes two already-verified pieces:
  ...
  (2) The verified induced-dipole levitation force
      (levitation_sphere_force.py, coefficient pinned to the perfect-
...
Run:  python coil_levitation_equilibrium.py     (a few seconds)
"""
import json
import os
import sys
...
from levitation_sphere_force import G_exact, delta, a, sigma  # noqa: E402
...
def main():
    ...
    try:
        ...
        # ============================================================
        import levitation_sphere_force as _Lm
        ...
        out_json = os.path.join(HERE, "coil_levitation_equilibrium_results.json")
...
def plot(zs, Fz, weight, z_star, F_peak, z_peak):
    ...
    out_png = os.path.join(HERE, "coil_levitation_equilibrium.png")

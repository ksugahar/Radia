"""levitation_sphere_force.py -- induced-dipole AC levitation force on a
...
Run:  python levitation_sphere_force.py     (a few seconds; pure numpy)
"""
import json
import os
...
def main():
    ...
    with open(os.path.join(HERE, "levitation_sphere_force_results.json"), "w") as fp:
        json.dump(data, fp, indent=2)
    print(f"\n wrote levitation_sphere_force_results.json")
...
def plot(fs, lift, F_pc):
    ...
    out = os.path.join(HERE, "levitation_sphere_force_vs_freq.png")

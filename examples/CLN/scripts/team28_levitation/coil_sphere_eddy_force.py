...
Motivation (the honest caveat in coil_levitation_equilibrium.py / README.md):
...
# to reuse directly.
from levitation_sphere_force import delta, _cot, sigma as SIGMA_CU  # noqa: E402
...
def G_of_radius(a_sphere, omega):
    ...
    Landau-Lifshitz ECM sec. 59 (same as levitation_sphere_force.G_exact but
...
# ----- coil (matches coil_levitation_equilibrium.py: 30 mm, 10000 At) -----
...
def lorentz_force_on_sphere(fes, fesPhi, fesB, sig, gfuB, s, mesh, p=P_ORDER):
    ...
    of levitation_sphere_force.py, whose coefficient is likewise the (1/2)

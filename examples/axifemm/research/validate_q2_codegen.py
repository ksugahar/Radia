...
agree with the high-order Gauss prototype (axifemm/axifemm_quad_q2.py).
...
PROTO = Path("W:/30_CauerLadderNetwork/2026_04_01_長方形CLN/axifemm")
...
def main():
    ...
    # recomputing the inner integral exactly as axifemm_quad_q2 does.
    from axifemm_quad_q2 import _GL8_x, _GL8_w, _phi_dPhiDs, _phi_dPhiDz

...
|--------:|--------|-------:|---------:|-------:|-----:|---------:|---------:|---------:|------:|
| 716,184 | LU | 1193 MB | - | 0 | 2 | 3.46s | - | 1.88s | 5.6s |
| 716,200 | BiCGSTAB | 347 MB | - | 16 | 3 | 3.46s | - | 0.41s | 3.9s |
| 716,192 | HACApK | 210 MB | **47%** | 12 | 2 | 0.01s | 5.43s | 0.28s | 5.7s |
...
| M_avg_z | Solver | Memory | Compress | Linear | Nonl | MatBuild | H-matrix | LinSolve | Total |
|--------:|--------|-------:|---------:|-------:|-----:|---------:|---------:|---------:|------:|
| 816,133 | LU | 193 MB | - | 0 | 2 | 0.24s | - | 0.40s | 0.68s |
...
| M_avg_z | Solver | Memory | Compress | Linear | Nonl | MatBuild | H-matrix | LinSolve | Total |
|--------:|--------|-------:|---------:|-------:|-----:|---------:|---------:|---------:|------:|
| 748,693 | LU | 1601 MB | - | 0 | 2 | 3.01s | - | 6.96s | 10.1s |
...
| M_avg_z | Solver | Memory | Compress | Linear | Nonl | MatBuild | H-matrix | LinSolve | Total |
|--------:|--------|-------:|---------:|-------:|-----:|---------:|---------:|---------:|------:|
| 754,617 | LU | 7810 MB | - | 0 | 2 | 15.6s | - | 73.0s | 90.7s |

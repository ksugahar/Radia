...
# insensitive, demo_qq); the genuine merit is carrying EXTERIOR SCATTERERS / MATERIAL.
#
...
#     independent (demo_qq), so Kelvin's effective infinite placement buys almost nothing in vacuum;
...
# outgoing); the Kelvin FE is demo_mm's with the scatterer's wavenumber mapped into the inverted shell.
import os

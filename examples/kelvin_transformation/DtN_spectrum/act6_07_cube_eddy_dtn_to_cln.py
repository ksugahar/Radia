# -*- coding: utf-8 -*-
r"""
act6_07_cube_eddy_dtn_to_cln.py  (Track A -- 3-D NON-SEPARABLE eddy DtN -> CLN)
================================================================================
...
act6_06_square_eddy_dtn_to_cln did this in 2-D (square, C4v); here the body is a cube (O_h, not O(3)), so
...
the residual DC floor is act6_01_kelvin_fem_eddy_dtn's (R/r')^2-weighted ball (3-D is NOT conformal --
unlike the 2-D Kelvin disk, act6_08_disk2d_kelvin_eddy_dtn).  The point is the NON-SEPARABLE 3-D build + CLN.
...
print("=" * 78)
print(" act6_07_cube_eddy_dtn_to_cln : NON-SEPARABLE cube eddy DtN (Kelvin/FEM build) -> CLN (3-D)")
print("=" * 78)
...
print("  (Large Dirichlet sphere here; the DC floor is removed by act6_01_kelvin_fem_eddy_dtn's (R/r')^2 Kelvin ball.)")
print("\nALL CHECKS PASSED.")

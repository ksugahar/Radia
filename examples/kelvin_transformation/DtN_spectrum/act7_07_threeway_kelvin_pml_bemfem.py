...
#                 matched Kelvin-transformed HOIBC at the inner image sphere (act7_03_hoibc_kelvin_transform/ll/mm). Sparse;
...
def fe_kelvin(n, k, a, b, M, inner):
    """matched-HOIBC Kelvin FE (act7_05_fe_kelvin_hoibc): image shell [a^2/b, a], transformation-optics medium."""
    rb = a * a / b

...
# A->B.n->scalar-DtN detour of act0_06_aform_dtn_gradient. The continuation of the alpha singular-material
...
print("\n-> the HCurl Kelvin ball recovers the vector magnetic Steklov eigenvalue n/R (dipole 1/R);"
      "\n   the singular material is integrable (act3_01_infinity_integrable) and the gradient null space is gauged.")

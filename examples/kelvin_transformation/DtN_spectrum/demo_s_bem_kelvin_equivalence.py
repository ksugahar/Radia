...
# kelvin_exterior_mesh.py) and the singular-kernel quadrature (BEM) are NOT the bottleneck. At a
# FIXED matched trace order the two differ only by a method-specific CONSTANT that does not scale;
# the difference that SCALES is COST (sparse vs dense, cf demo_r), not accuracy.
#

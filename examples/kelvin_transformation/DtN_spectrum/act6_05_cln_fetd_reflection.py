# -*- coding: utf-8 -*-
r"""
act6_05_cln_fetd_reflection.py  (Track A -- CLN open boundary, transient FETD)
==============================================================================
...
diffusive analog of act6_11_exact_dtn_fetd (which did the wave-equation reflection test).
...
full-domain reference -- exactly as act6_11_exact_dtn_fetd did for the wave case.
...
ladder of act6_04_cln_mor_radial_eddy, now as a substructure) is coupled back to the interior at R0
...
RELATION TO THE SIBLINGS:
  act6_11_exact_dtn_fetd : the SAME reflection test for the WAVE equation (rational-in-s DtN).
  act6_02_cln_dtn_cauer : the diffusion DtN as an EXACT Cauer fraction in q=sqrt(s).
  act6_04_cln_mor_radial_eddy : the GENUINE CLN ladder from a radial eddy FEM (frequency domain).
  act6_05_cln_fetd_reflection : (this) that CLN ladder USED as a transient open boundary -- it works.
...
# ===========================================================================
print("=" * 78)
print(" act6_05_cln_fetd_reflection : the CLN open boundary in a transient eddy-current FETD")
print("=" * 78)
...
print("    moment-matching substructuring (the act6_04_cln_mor_radial_eddy ladder as a substructure) --")
...
print("  * This is the diffusive analog of act6_11_exact_dtn_fetd (the wave reflection test): the")

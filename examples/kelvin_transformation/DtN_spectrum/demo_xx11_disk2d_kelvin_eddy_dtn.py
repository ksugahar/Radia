# -*- coding: utf-8 -*-
r"""
demo_xx11_disk2d_kelvin_eddy_dtn.py  (Track A -- 2-D CONFORMAL Kelvin disk, NO weight)
=====================================================================================
The refinement promised by demo_xx9: removing the residual DC floor of the 2-D
...
needs NO material weight -- unlike the 3-D Kelvin ball (demo_xx8), which carries the
...
2-D analog of the 3-D demo_xx8; gluing it to the non-separable square (demo_xx9) is
...
def kelvin_disk_stiffness(nodes, m, R, mode):
    ...
    mode='weight3d' (WRONG in 2-D): the 3-D Kelvin-ball weight (R/r')^2 (demo_xx8) --
...
# =====================================================================================
print("=" * 78)
print(" demo_xx11 : 2-D CONFORMAL Kelvin disk (NO weight) -- removes demo_xx9's DC floor")
print("=" * 78)
...
print(f"     reverse-Bessel, demo_xx7 -- so CLN is a band APPROXIMATION, not machine-exact)")
...
print("  stiffness with NO material weight (vs the 3-D ball's (R/r')^2, demo_xx8): it hits")
...
print("  This is the 2-D analog of demo_xx8 and removes demo_xx9's residual DC floor.")
print("\nALL CHECKS PASSED.")

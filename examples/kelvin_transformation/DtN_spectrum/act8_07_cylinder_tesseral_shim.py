"""act8_07_cylinder_tesseral_shim -- hardening the iron-aware coil design: NON-spherical former, TESSERAL shim,
MANUFACTURABLE contours, and an INDEPENDENT cross-validation (Track B, steps 1-4).

act8_03_general_iron_design/act8_06_streamfunction_ridge_with_dtn proved iron-aware stream-function design on a SPHERE former with a low-order target.
...
floors at ~8% (the Kelvin side itself is analytic-anchored to 1e-4 on the sphere sub-case, act8_03_general_iron_design, and
...
Run:  pip install -e packages/radia-mcp ; python act8_07_cylinder_tesseral_shim.py
...
def main():
    print("=" * 96)
    print("act8_07_cylinder_tesseral_shim -- cylinder former + off-axis iron: tesseral shim, manufacturable, cross-validated")
    print("=" * 96)
    with TaskManager():
    ...
    print("         METHOD is validated by (a) <0.5%% + the act8_03_general_iron_design analytic anchor 1e-4 on the sphere)")

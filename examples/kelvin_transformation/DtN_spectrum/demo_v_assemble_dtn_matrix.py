...
# Kelvin-FEM operator A (demo_r): eliminate the exterior-volume DoFs, keep the Gamma DoFs:
...
# deflation lands ~3.0, not 2/a). Net-charge/monopole problems need a finite ground or the demo_p

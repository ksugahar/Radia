# -*- coding: utf-8 -*-
r"""
act2_07_apparatus_design_calc.py  (Kelvin mesh-adequacy: an ENGINEERING apparatus)
====================================================================================
...
VERIFIED HERE (asserted; self-contained numpy):
  [1] the apparatus multipole content (current moments) == an FFT of A_z on Gamma (machine
      ...
      decays geometrically with a_app/R (the criterion's source side, act2_04_adequacy_eccentric_multibody).
  [2] the design calc: R* ~ 3 a_app (the "air box 2-5x" optimum, act1_04_optimal_R) and p* from the
...
of the same chain is act2_06_eccentric_fem_endtoend (a point source) -- here the point is the DESIGN CALCULATION
...
print("=" * 78)
print(" act2_07_apparatus_design_calc : Kelvin DESIGN CALCULATION for a reactor/transformer leg winding")
print("=" * 78)
...
# rule, like the magnetized square's n=4k+1 in act1_04_optimal_R); decay over the NON-ZERO modes:
...
print("  core only rescales the moments).  The mesh-adequacy criterion (act2_04_adequacy_eccentric_multibody/13), in practice.")
print("\nALL CHECKS PASSED.")

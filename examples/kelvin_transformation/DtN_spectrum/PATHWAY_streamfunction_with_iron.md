...
| `demo_nn` | **the current-sheet model on an ELLIPSOID via FE-direct Biot-Savart** (any winding surface). Sphere FE-direct H_s == analytic 2.4e-3; ellipsoid iron Kelvin vs graded air-box (~49k DoF) 6.9e-3 |

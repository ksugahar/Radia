# -*- coding: utf-8 -*-
r"""
act6_03_dtn_to_cln_wideband.py  (Track A -- DtN -> CLN as the axis: WIDE band)
==============================================================================
WIDENING the evanescent eddy-current band by making "DtN -> CLN" the axis.

act6_09_cln_vs_pml closed the open boundary by a Lanczos MOR of an EXTERIOR FEM and compared
...
(act6_02_cln_dtn_cauer) -- is EXACT for ALL s.  That is "DtN -> CLN": build the DtN (here in
...
PRIOR ART: same as act6_02_cln_dtn_cauer/xx6 (Grote-Keller/Hagstrom; SIBC Cauer Yuferev-Ida /
...
def dtn_ref(n, s):
    ...
    to ~1e-9 (cross-checked in [1] and in act6_02_cln_dtn_cauer) and is the wide-band reference.
    """
...
# ---- FEM-MOR CLN (act6_09_cln_vs_pml): Lanczos reduction of an exterior radial FEM ----
...
# ---- CFS-PML (act6_09_cln_vs_pml): stretch beta = 1 + sigma/(alpha + sqrt(s)) ----
...
print("=" * 78)
print(" act6_03_dtn_to_cln_wideband : DtN -> CLN as the axis -- WIDENING the evanescent eddy band")
print("=" * 78)

wide = 1j * np.logspace(-6, 5, 120)        # 11 decades (vs act6_09_cln_vs_pml's 4)
...
print(f"    -- a Foster-type structural mismatch, act6_02_cln_dtn_cauer [2]):")

...
# -- promoting the per-mode eigenvalue of act7_03_hoibc_kelvin_transform/ll/mm to the real surface operator in NGSolve.
#
# act7_05_fe_kelvin_hoibc realised the radiating extended-Kelvin boundary as a radial FE, with the angular
...
# Together with act7_05_fe_kelvin_hoibc (which verified the transformation-optics MEDIUM + the radial coupling to the
...
print("matched per-mode impedance Lambda_HOIBC,n. With act7_05_fe_kelvin_hoibc's transformation-optics volume medium +")

# -*- coding: utf-8 -*-
r"""
act7_14_iabc_static_elegant.py  (Track A -- kelvin branch)
==========================================================
...
THE ELEGANT REFORMULATION (this file, all numerically verified):
  ...
  (E) WHY no isotropic finite shell can be exact for ALL modes (the honest obstruction
      ...
      static sibling of the time-domain Bessel-filter network (act6_10_iabc_time_domain).
...
print("=" * 78)
print(" act7_14_iabc_static_elegant : ELEGANT derivation of the low-frequency (Laplace) IABC")
print("=" * 78)
...
print("    in the mode variable = the static sibling of act6_10_iabc_time_domain's Bessel-filter network.")
print("\nALL CHECKS PASSED.")

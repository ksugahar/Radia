# -*- coding: utf-8 -*-
r"""
act6_01_kelvin_fem_eddy_dtn.py  (Track A -- Kelvin-FEM BUILDS the eddy DtN)
===========================================================================
...
truncated FEM pays the (R0/Rfar)^(2n+1) closure floor (act6_09_cln_vs_pml [2]).  KELVIN fixes
...
VERIFIED HERE (asserted; self-contained numpy/scipy):
  ...
  [2] NO DC floor: at omega->0 the Kelvin-FEM DtN hits the exact static ladder,
      whereas the truncated FEM (act6_09_cln_vs_pml) floors at (R0/Rfar)^(2n+1).
...
# ---- truncated-FEM (act6_09_cln_vs_pml) eddy DtN: Dirichlet u=0 at Rfar (the DC-floor baseline) ----
...
# ===========================================================================
print("=" * 78)
print(" act6_01_kelvin_fem_eddy_dtn : Kelvin-FEM BUILDS the eddy DtN (radial proof-of-mechanism)")
print("=" * 78)
...
print(f"    the CLN ladder inherits the analytic exactness (act6_03_dtn_to_cln_wideband: 2 DOF, 11 decades).")
...
print("  with NO closure floor at DC (unlike a truncated FEM).  Feed it to CLN (act6_03_dtn_to_cln_wideband)")

...
# (the volume solve is Galerkin-exact at p>=n -- see act2_09_exterior_mesh.py), so the
...
# SPARSE (cf. act4_01_kelvin_vs_bem_cost). Below: the minimal unit-sphere ball (curvature-limited; maxh in

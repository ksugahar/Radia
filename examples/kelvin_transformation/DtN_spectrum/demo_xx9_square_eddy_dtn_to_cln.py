# -*- coding: utf-8 -*-
r"""
demo_xx9_square_eddy_dtn_to_cln.py  (Track A -- NON-SEPARABLE eddy DtN -> CLN)
=============================================================================
...
by CLN.  Radial demo_xx8 was the analytic-checkable proof-of-mechanism; here the
...
3-D demo_xx8 -- so a large Dirichlet circle already gives a small DC floor; the
...
print("=" * 78)
print(" demo_xx9 : NON-SEPARABLE square eddy DtN (Kelvin/FEM build) -> CLN")
print("=" * 78)

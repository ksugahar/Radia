...
# operator, which is method-agnostic (act4_04_sparse_factorization_of_kernel/act4_05_bem_kelvin_equivalence: they converge to one operator). The literature
...
print("   exterior material mu(x) |  needs layered/Sommerfeld G or a volume IE | arbitrary mu(x), native (act5_01_exterior_material/bb)")

...
#   reflectionless iff its impedance MATCHES the (transformed) radiation DtN -- the HOIBC of demo_kk.
#
...
#
# Pure numpy/scipy.  The TO medium is the general (coordinate-free) form of demo_kk's radial result;

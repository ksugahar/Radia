...
#     the k0->0 limit is exactly the static Lipschitz-Hankel kernel of demo_y.
...
# static limit: k0 -> 0 reproduces the demo_y static image (Lipschitz-Hankel) -----------------------
num0 = sommerfeld_refl(rho, z, zp, 1e-6)
stat = 1.0 / R_im                                   # static PEC image (1/R_im)
print("STATIC LIMIT k0->0: I_refl=%.8e  vs static 1/R_im=%.8e  rel=%.2e  (= demo_y kernel)"

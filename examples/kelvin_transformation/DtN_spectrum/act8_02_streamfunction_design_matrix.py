...
# Green-function-free (act1_05_assemble_dtn_matrix/w/bb/ee). This is exactly act4_07_when_form_dtn's "form Lambda when the OPERATOR is the
...
# radial transfer (the SAME factor verified to ~1e-4 vs analytic in act8_01_streamfunction_coil_with_iron) and P_n the Legendre angle.
...
def R_ext(n, mu_s):
    """iron-loaded external radial transfer R_n(r_t), Dirichlet R_n(a)=1 (= act8_01_streamfunction_coil_with_iron, Kelvin-FEM-verified)."""
...
print("  material-aware M (Kelvin-FEM-formed, act1_05_assemble_dtn_matrix/ee):\n", np.array2string(M_iron, precision=4))
...
print("   is exactly why the stream-function method WANTS the DtN'd matrix, and why forming it (act4_07_when_form_dtn)")

# -*- coding: utf-8 -*-
r"""
demo_wc_dispersive_iabc.py  (Track A -- kelvin branch)
======================================================
...
This refines demo_wb (constant passive shell, ~8.7% band reflection, "no
dispersion") and demo_zz (the exact-null per-omega optimum is non-passive).
...
transfer matrices (same kernel as demo_zz/demo_wb).  We MINIMIZE the band-max
...
PROVEN HERE (all asserted):
  ...
  (5) HANKEL CONTINUED FRACTION -- needed?  The EXACT lossless exterior DtN is a
      ...
      h_n^{(1)} (the reverse-Bessel-polynomial / Bessel-filter set, demo_uu); its
...
local NRBC (demo_uu).  New angle (knowledge module, not asserted as theorem): the
...
print("=" * 74)
print(" demo_wc: time-domain IABC by passive dispersive (URN/Debye) shell")
print("=" * 74)
...
print("    => Hankel CF is the EXACT lossless reference (finite n poles, demo_uu);")

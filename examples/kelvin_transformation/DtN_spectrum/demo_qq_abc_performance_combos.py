...
#     not for free (near-centre resolution, demo_kk), and a floor remains -> worse than Kelvin+PML;
...
#
# Pure numpy/scipy (radial FEs / closed-form propagation; the assemblies are demo_nn's).
import os

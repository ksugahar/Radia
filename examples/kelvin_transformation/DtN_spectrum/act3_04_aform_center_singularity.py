# -*- coding: utf-8 -*-
r"""
act3_04_aform_center_singularity.py  (Kelvin: the A-form CENTRE asymmetry)
============================================================================
...
centre-less DtN (FEM-BEM) that never creates the centre node."  act3_03_vector_dtn already shows
...
VERIFIED HERE (asserted; NGSolve, reuses act3_03_vector_dtn's scalar + A-form solves):
...
ngsbem path).  act3_03_vector_dtn confirms the volume A-form still works (coarse mesh + gauge).
...
print("=" * 78)
print(" act3_04_aform_center_singularity : Kelvin A-form CENTRE asymmetry (scalar diverges & is pinned;")

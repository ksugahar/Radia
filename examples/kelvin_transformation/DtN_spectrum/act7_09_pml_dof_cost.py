# -*- coding: utf-8 -*-
r"""
act7_09_pml_dof_cost.py  (Track A -- kelvin branch)
================================================
...
The honest framing this pins (no overclaim -- every 'ok' gated on a number):
  ...
  multipole degree n present; see act4_02_kelvin_approximates_bem.py) and the
...
print("=" * 78)
print(" act7_09_pml_dof_cost: PML buys accuracy with DoF; Kelvin with geometry order")
print("=" * 78)

# ===========================================================================
# [P] PML radial DoF to reach a target DtN accuracy (low frequency kR=0.2)
#     1-D radial complex-stretch DtN, lifted from act1_06_spectrum_n1to9.py [C].
# ===========================================================================

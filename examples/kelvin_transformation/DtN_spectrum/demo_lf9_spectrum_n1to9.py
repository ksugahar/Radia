# -*- coding: utf-8 -*-
r"""
demo_lf9_spectrum_n1to9.py  (Track A -- kelvin branch)
======================================================
...
PROVEN HERE (all asserted; no overclaim, every 'ok' gated on a computed number):
  ...
  [C] PML (radial complex stretch, kR=0.2): accurate & ~flat (~1e-5 band) across n
      (no DtN-accuracy breakdown; its low-freq catch is conditioning, demo_pp).
...
print("=" * 78)
print(" demo_lf9: committed n=1..9 Kelvin/BEM/PML spectrum + cost (backs fig:vsalt)")
print("=" * 78)

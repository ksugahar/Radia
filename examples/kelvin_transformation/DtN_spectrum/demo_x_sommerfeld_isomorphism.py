...
#
# demo_t/u/v/w used spherically-LAYERED exteriors (Mie/transfer-matrix). The genuine Sommerfeld case
...
# n=0 monopole (which a 3D point-ground cannot hold, see demo_v) is not excited -- as two small
...
def solve():
    ...
    # mode is never excited (a residual net charge would blow it up ~1e7x; see demo_v).

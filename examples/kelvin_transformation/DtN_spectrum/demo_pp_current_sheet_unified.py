...
#
# This is the gap-free counterpart of the HYBRID reduced-potential demos (demo_mm/nn/oo), which add
...
#
# Geometry + psi normalisation match demo_mm (sphere coil r=a, psi = P_2, iron shell [b,c], MU_R=50)
# so this validates against demo_mm's two checks: vacuum == analytic Biot-Savart, and (with iron) an
...
# psi = S2/a^2 = P_2(cos th) on r=a (matches demo_mm's unit-P_2 sheet).  S2 = z^2 - (x^2+y^2)/2 is

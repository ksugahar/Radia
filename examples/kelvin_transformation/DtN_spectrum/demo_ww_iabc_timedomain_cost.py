# -*- coding: utf-8 -*-
r"""
demo_ww_iabc_timedomain_cost.py  (Track A -- kelvin branch)
==========================================================
...
THE PICTURE (all numerically verified below):
  * The exact exterior DtN per spherical-harmonic mode n is RATIONAL in z=kR=omega R/c
    (demo_uu): Lambda_n(z) = i z - 1 + sum_{j=1..n} z_j/(z - z_j), poles z_j = the
...
print("=" * 78)
print(" demo_ww : TIME-DOMAIN high-frequency IABC + DtN cost")
print("=" * 78)

"""demo_jj -- Can ACA-TSVD be applied to the DtN/Kelvin material-aware transfer matrix M?
...
Answer (verified below): YES, but the two ingredients answer two different questions.
  ...
  * TSVD  -- applies to the GLOBAL inverse design `psi = M^+ B_target`, unchanged, and is
            ...
            rather than free-space Biot-Savart.  (demo_hh/demo_ff already use `tsvd_pinv`.)

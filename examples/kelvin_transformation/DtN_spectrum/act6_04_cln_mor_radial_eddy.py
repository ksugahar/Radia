# -*- coding: utf-8 -*-
r"""
act6_04_cln_mor_radial_eddy.py  (Track A -- the GENUINE lab CLN open boundary)
==============================================================================
...
reproduces the exact diffusion open-boundary DtN.  This complements act6_02_cln_dtn_cauer
...
RELATION TO THE SIBLINGS:
  * act6_10_iabc_time_domain / act6_11_exact_dtn_fetd : wave/air DtN, rational in s, exact realisation.
  * act6_02_cln_dtn_cauer           : diffusion DtN, EXACT Cauer in q=sqrt(s) (n+1 stages,
                         fractional) -- the structural unification.
  * act6_04_cln_mor_radial_eddy (this)    : diffusion DtN, GENUINE lab CLN MOR on the FEM ->
...
# ===========================================================================
print("=" * 78)
print(" act6_04_cln_mor_radial_eddy : the GENUINE lab CLN open boundary (Lanczos MOR of a radial eddy FEM)")
print("=" * 78)
...
print("  * Complements act6_02_cln_dtn_cauer (the EXACT n+1-stage Cauer in q=sqrt(s)): there the")
...
print("  * With act6_10_iabc_time_domain/uu2 (wave) this completes the reverse-Bessel/Cauer picture:")

# -*- coding: utf-8 -*-
r"""
act2_04_adequacy_eccentric_multibody.py  (Kelvin mesh-adequacy: the source side)
==================================================================================
...
verified in act0_02_p_vs_h_study / the paper S3.2), so dropping m>p leaves a relative field
...
the geometry FLOOR half (curved-sphere error at fixed p) is act2_03_floor_vs_curve.  Together
...
print("=" * 78)
print(" act2_04_adequacy_eccentric_multibody : Kelvin mesh-adequacy -- the SOURCE side (eccentric / multi-body)")
print("=" * 78)
...
print("  act2_03_floor_vs_curve is the geometry-floor half.  Centre the sphere to keep p small.")
print("\nALL CHECKS PASSED.")

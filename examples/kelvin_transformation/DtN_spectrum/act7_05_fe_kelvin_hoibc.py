...
# to the closed-form (act7_03_hoibc_kelvin_transform/ll). "From derivation to a method that runs."
#
...
#   transformation-optics weak form (act7_04_transformation_optics_impedance medium, scalar Helmholtz -> act7_03_hoibc_kelvin_transform image ODE):
...
#     sphere rho=a (the act7_03_hoibc_kelvin_transform/ll sign-flip), and (A R)|_a is the consistent-flux reaction.
#
...
#
# Pure numpy/scipy FE (dense small systems). The medium/coefficients are exactly act7_04_transformation_optics_impedance's
# transformation-optics medium; the boundary is exactly act7_03_hoibc_kelvin_transform's Kelvin-transformed HOIBC.
import os
...
print("than a constant 377-ohm SIBC. The derivation (act7_03_hoibc_kelvin_transform/ll) is now a method that runs; the")

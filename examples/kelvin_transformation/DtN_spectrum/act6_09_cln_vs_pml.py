# -*- coding: utf-8 -*-
r"""
act6_09_cln_vs_pml.py  (Track A -- CLN vs PML in the DC-to-evanescent regime)
=============================================================================
...
against the CFS-PML variant that was invented precisely for this regime.
  ...
  CLN      : Lanczos/PVL reduction of the EXACT exterior FEM (act6_04_cln_mor_radial_eddy); N ladder
...
EXPLICIT NON-CLAIMS (where this does NOT say CLN wins):
  * NOT PML's home -- propagating waves.  That is the WAVE operator (act6_10_iabc_time_domain/pp),
...
54(3):7201804 (2018).  Lab wave-side Kelvin-vs-PML: act7_07_threeway_kelvin_pml_bemfem/pp/qq/rr.
...
print("=" * 78)
print(" act6_09_cln_vs_pml : CLN vs PML / CFS-PML  --  DC-to-evanescent eddy-current band")
print("=" * 78)

# -*- coding: utf-8 -*-
r"""
act7_16_wideband_iabc.py  (Track A -- kelvin branch)
====================================================
WIDEBAND high-frequency IABC by WLS + shell-width control -- resolving the act7_19_highfreq_iabc_revisited obstruction
(user: "you may build it with WLS; the IABC width can be controlled, so can we make it wideband?").

act7_19_highfreq_iabc_revisited showed that demanding EXACT reflection-null at one frequency forces the shell materials to be
...
VERIFIED HERE (all asserted; self-contained, ports only the published analytic Mie/IABC method):
  (A) RECAP act7_19_highfreq_iabc_revisited: exact-null at one omega is NON-PASSIVE (Im(eps)>0).
  ...
  (D) GRADED layers push the mid/upper band to <1%. All designs PASSIVE and CONSTANT => trivial,
      stable time domain (no dispersion). This RESOLVES the act7_19_highfreq_iabc_revisited passivity obstruction.
...
# --- spherical / Riccati-Bessel + Mie multilayer reflection (from act7_19_highfreq_iabc_revisited) ----
def _sb(k, n, z):
...
print("=" * 78)
print(" act7_16_wideband_iabc : WIDEBAND high-frequency IABC by WLS + width control (passive, dispersion-free)")
print("=" * 78)

# ---------------------------------------------------------------------------
# (A) recap act7_19_highfreq_iabc_revisited: exact-null at one omega is NON-PASSIVE
...
print("""
[interpretation] -- the wideband route (user's WLS + width idea) RESOLVES act7_19_highfreq_iabc_revisited:
  * exact-null per omega  -> dispersive + NON-PASSIVE (no clean time domain)        [act7_19_highfreq_iabc_revisited]

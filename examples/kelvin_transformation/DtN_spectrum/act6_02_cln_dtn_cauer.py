# -*- coding: utf-8 -*-
r"""
act6_02_cln_dtn_cauer.py  (Track A -- the CLN open-boundary condition)
=======================================================================
...
with the SAME poles; only the variable differs:
    ...
    ------------------  ---------  --------------------------------  --------------
    wave (Helmholtz)    s          rational in s  (act6_10_iabc_time_domain)          roots(theta_n)
...
continued-fraction LADDER realises BOTH exactly -- the wave one in s (act6_10_iabc_time_domain),
...
DIFFUSION DtN (a=1, mu*sigma=1, s=i*omega; from act6_12_iabc_diffusion_timedomain):
...
VERIFIED HERE (all asserted; self-contained numpy/scipy):
  ...
  (2) CLN realisation: the diffusion DtN as a Cauer continued fraction in
      ...
      band approximation instead, act6_06_square_eddy_dtn_to_cln/xx10.)
...
# ---------------------------------------------------------------------------
# wave (Helmholtz) exterior DtN -- rational in s  (the act6_10_iabc_time_domain structure)
# ---------------------------------------------------------------------------
def sph_h1(n, z):
...
# ===========================================================================
print("=" * 78)
print(" act6_02_cln_dtn_cauer : the CLN open-boundary condition (Cauer ladder, wave + diffusion)")
print("=" * 78)
...
print("    with poles roots(theta_n) for BOTH the wave (variable s, act6_10_iabc_time_domain) and the")

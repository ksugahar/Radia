...
#       material, demo_t) -- NOT about the PML's continuous DtN being inaccurate. At quasi-static the
...
# is the best sparse absorber (demo_nn); low-freq/quasi-static (the SA regime) -> Kelvin is the exact,
...
#
# Pure numpy/scipy (radial FEs; the PML/Kelvin assemblies are demo_nn's).
import os
...
print("wave-absorber mis-applied there. High-freq vacuum radiation still favours a tuned PML (demo_nn).")
print("=" * 82)

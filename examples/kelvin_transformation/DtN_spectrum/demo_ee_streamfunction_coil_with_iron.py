...
# shows the Kelvin-FEM operator is the correct material-aware coil kernel. This is exactly demo_dd's
...
print("   (rel ~1e-3), Green-function-free and for arbitrary iron geometry (demo_bb) -- THE kernel a")
print("   stream-function coil design needs when magnetic material is present, and the case where")
print("   forming the operator (demo_dd) is justified (the design/inverse problem consumes it).")

"""Fig_2: 2x2 panel contour+streamline plot for 3D quadrupole H-field.

Ported from Fig_2.m (MATLAB). Loads .mat data files produced by
3D_quadrupole.py and 3D_quadrupole_with_Kelvin.py.
...
def main():
    ...
    panels = [
        ((0, 0), "3D_quadrupole_with_Kelvin.mat", "analytical", "(a)"),
        ((0, 1), "3D_quadrupole.mat", "fem", "(b)"),
        ((1, 0), "3D_quadrupole_with_Kelvin.mat", "fem", "(c)"),
        ((1, 1), "3D_quadrupole_with_Kelvin.mat", "exterior", "(d)"),
    ]

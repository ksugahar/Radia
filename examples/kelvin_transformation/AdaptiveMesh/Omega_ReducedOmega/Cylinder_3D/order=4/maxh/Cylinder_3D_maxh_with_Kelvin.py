...
print("MAXH-BASED REFINEMENT - 1/8 Model (Octant) - CYLINDER")
print("=" * 60)
...
def output_vtk(mesh, iteration, output_data):
	...
	temp_basename = f"Cylinder_3D_maxh_with_Kelvin_iter_{iteration:02d}"
...
def generate_convergence_plot(iter_num, history, output_data, current_maxh):
	...
	plt.suptitle(f'Cylinder Iteration {iter_num}: DOFs={history["ndof"][-1]}, maxh={current_maxh:.4f}, Error={history["error"][-1]:.2e}',

...
WITH MAXH-BASED MESH REFINEMENT
...
print("MAXH-BASED REFINEMENT - 1/8 Model (Octant) - CUBE")
print("=" * 60)
...
def solve_omega_formulation(mesh, fe_order):
	...
	mu_kelvin_factor = kelvin_mu_factor_3d_cf(center=(center_x_ext, 0.0, 0.0),
	                                           R=kelvin_radius)
...
def output_vtk(mesh, iteration, output_data):
	...
	temp_basename = f"Cube_3D_maxh_with_Kelvin_iter_{iteration:02d}"
...
with TaskManager():
    ...
    while True:
    	...
    	# Regenerate mesh with current maxh

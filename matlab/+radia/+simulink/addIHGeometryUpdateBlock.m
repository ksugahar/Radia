...
mask.addParameter(Type="popup", Name="thermal_order", ...
    Prompt="Thermal H1 order", TypeOptions={"1", "2"}, Value="1");
...
mask.addParameter(Type="edit", Name="python_executable", ...
    ...
    Evaluate="off");
mask.addParameter(Type="edit", Name="axisymmetric_thermal_vol", ...
    Prompt="Axisymmetric thermal .vol (blank: 3D heat)", Value="", Evaluate="off");
mask.addParameter(Type="edit", Name="n_phi_samples", ...
    Prompt="Azimuth samples for axisymmetric heat", Value="128", Evaluate="off");

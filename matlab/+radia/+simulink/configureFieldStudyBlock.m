...
mask.Description= ...
    "Compile electrostatic, multi-conductor force, current-flow, steady/transient-heat, " + ...
    "or linear/nonlinear harmonic-eddy setup " + ...
...
set_param(blockPath,"UserData",struct("schema","radia.simulink.field-study.v1", ...
    "physics","electrostatic,electrostatic_system,current_flow,steady_heat,transient_heat,harmonic_eddy", ...

...
%   map. This entry point is first order; T and U are identically zero. Use
%   radia.beam.propagateGridFunctionMultipoleMap for the declared paraxial
%   A/F2/F3 expansion and region-attributed R/T/U map.

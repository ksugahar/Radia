...
def test_pre_push_runs_the_unpushed_candidate_on_mdx():
    ...
    assert "numpy pytest pyyaml setuptools 'mcp>=1.0,<2'" in helper
    assert 'import mcp, numpy, pytest, setuptools, yaml' in helper
...
def test_agent_policies_stay_compact_and_share_one_policy_body():
    ...
    # Runtime ownership must survive both agents' policy updates. This checks

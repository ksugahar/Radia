...
PERFORMANCE = {
    "RADIA_HDIV_DISABLE_CONGRUENT_CACHE",
...
NUMERICAL_PATH = {
    ...
    "RADIA_HDIV_DISABLE_HO_IMAGE_FAR",
    "RADIA_HDIV_HEX_CLUSTER_RADIUS",
    "RADIA_HDIV_HEX_PAIR_DUFFY",
    "RADIA_HDIV_HEX_DISTORTED_FAR_FACTOR",
    "RADIA_HDIV_HEX_FAR_ONESIDED",
    "RADIA_HDIV_HEX_GLPAIR_W_N",
    "RADIA_HDIV_HEX_MAX_ANISOTROPY",

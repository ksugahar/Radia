...
input for ``tests/panels/test_heat_workpiece_only.py``.
...
Run::
    ...
    python tests/panels/fixtures/generate_heat_multimaterial.py

to (re)write::

    tests/panels/fixtures/heat_multimaterial_coil_wp.vol
"""

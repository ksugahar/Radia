"""
Test Gmsh v4 export via cubit.cmd('radia_export gmsh ... version 4 ...').
...
def test_format_version():
	...
	cubit.cmd(f'radia_export gmsh "{msh_file}" version 4 overwrite')
...
def test_2d_mesh_normal_orientation():
	...
	cubit.cmd(f'radia_export gmsh "{msh_file}" version 4 dimension 2 overwrite')

...
Usage:
  python tests/cubit/test_ho_area_circle.py
"""
...
def main():
    ...
    test_cases = [
        ("GMSH v2.2", ".msh",
         'export gmsh "{f}" order {o} version 2 dimension 2 overwrite',
         parse_gmsh_area),
        ("GMSH v4.1", ".msh",
         'export gmsh "{f}" order {o} version 4 dimension 2 overwrite',
         parse_gmsh_area),
        ("Nastran", ".bdf",
         'export nastran "{f}" order {o} dimension 2 overwrite',
         parse_nastran_area),
        ("VTK", ".vtk",

...
from radia.ltspice.bandwidth_gate import measure_bandwidth_crossing_gate
from radia.ltspice.mcp_server import measure_bandwidth_crossing_gate as mcp_gate

...
from radia.ltspice.bipolar_efficiency_gate import bipolar_converter_efficiency_gate
from radia.ltspice.mcp_server import bipolar_converter_efficiency_gate as mcp_gate

...
def _python_q1_quad_matrices(ra, rb, za, zb, mu, sigma):
    ...
    """
    from axifemm_quad import element_matrices_quad, element_sigma_mass_quad
...
def test_q1_quad_cpp_vs_python(ra, rb, za, zb, label):
    """C++ AxiHenrotteFE_Q1_AxisAligned matches axifemm_quad.py prototype
...
def test_python_ref_self_consistency_p1_triangle():
    ...
    _reference_python/axifemm_core.py and its element_matrices()
    ...
    """
    from axifemm_core import element_matrices, MU0

"""Golden tests for the radia-maglev Mixed-Galerkin polarizability stack.
...
from radia.maglev.mixed_galerkin import rom_fit as RF
from radia.maglev.simulink import export as EX
...
def test_cube_cad_topology_c1():
    ...
    from radia.maglev.mixed_galerkin import cad_edges as CE

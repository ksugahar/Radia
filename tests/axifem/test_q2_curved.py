...
Henrotte quad element (Phase B6 C++ port of axifem_quad_q2_curved.py).
...
Requires the rebuilt axifem extension (Build.ps1 -AxiFemOnly).  The repo build
...
from ngsolve import BilinearForm, CoefficientFunction as CF

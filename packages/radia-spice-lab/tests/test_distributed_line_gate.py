...
from ltspice_converter.distributed_line_gate import distributed_line_delay_loss_gate
from ltspice_converter.mcp_server import distributed_line_delay_loss_gate as mcp_gate

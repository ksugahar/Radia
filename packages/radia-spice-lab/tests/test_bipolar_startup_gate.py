...
from ltspice_converter.bipolar_startup_gate import bipolar_supply_startup_gate
from ltspice_converter.mcp_server import bipolar_supply_startup_gate as mcp_gate

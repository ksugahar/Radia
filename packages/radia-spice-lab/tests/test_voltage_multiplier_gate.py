from ltspice_converter.mcp_server import cockcroft_walton_stage_gate as mcp_gate
from ltspice_converter.voltage_multiplier_gate import cockcroft_walton_stage_gate

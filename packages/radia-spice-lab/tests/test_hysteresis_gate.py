from ltspice_converter.hysteresis_gate import hysteretic_inductor_cycle_gate
from ltspice_converter.mcp_server import hysteretic_inductor_cycle_gate as mcp_gate

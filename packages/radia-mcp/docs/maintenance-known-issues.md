...
| M04 / high | bibliography: nested braces, false title matches, transient DOI errors | Reconciliation P28, P60–P68 | Named parser/title/HTTP cases 修正済み; Crossref missing publication metadata/corporate authors and Crossref/IEEE DOI encoding have offline regression evidence (715-test lane). Other consumers, escaped entities and partial author lists remain 検証待ち |

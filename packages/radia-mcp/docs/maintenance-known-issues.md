...
| M04 / high | bibliography: nested braces, false title matches, transient DOI errors | Reconciliation P28, P60–P68 | Named parser/title/HTTP cases 修正済み; Crossref metadata/partial-author checks, Crossref/IEEE DOI encoding, and Crossref/arXiv-direct text escaping and full returned author lists have offline evidence (745-test lane). Other producers and rendered bibliography acceptance remain 検証待ち; unsupported math/markup requires manual verification |

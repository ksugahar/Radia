...
| M04 / high | bibliography: nested braces, false title matches, transient DOI errors | Reconciliation P28, P60–P68 | Named parser/title/HTTP cases 修正済み; metadata/author/escaping and DOI normalization cases have scoped evidence. Citation/bibliography failures and Crossref/IEEE/arXiv/S2 resource closure have offline regressions (845-test lane); malformed S2 graph data is not a zero-result success. Other producers and rendered bibliography acceptance remain 検証待ち; unsupported math/markup requires manual verification |

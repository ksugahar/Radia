...
| M06 / medium | paper: PDF diagnostics | Reconciliation P39–P50 | Named crop/float/threshold cases and four detectors' extraction-failure/closure paths have focused evidence; visual accuracy, vector figures and rendering-helper closure remain 検証待ち |

...
| M07 / high | paper: external review follow-up | Full report mapped in reconciliation P01–P76; groups may contain related findings | Inventory complete, not fixes complete. P12/P31/P32/P37/P38/P51/P52 and T8→T20→T18 phase2 have scoped regression evidence; T16/T17, later phases and external-input/PDF findings remain open |

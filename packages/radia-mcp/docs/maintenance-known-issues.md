...
| M04 / high | bibliography: nested braces, false title matches, transient DOI errors | Reconciliation P28, P60–P68 | Named parser/title/HTTP cases 修正済み; metadata/author/escaping and DOI normalization cases have scoped evidence. Citation resolver/generator failures and bibliography read failures have offline regressions (768-test lane). Other producers and rendered bibliography acceptance remain 検証待ち; unsupported math/markup requires manual verification |
...
| M07 / high | paper: external review follow-up | Full report mapped in reconciliation P01–P76; groups may contain related findings | Inventory complete, not fixes complete. Gate and composite execution-status fixes have scoped evidence, including T16/T17 and T18 phase3/5/6. Missing pattern producers, semantic rules and external-input/PDF findings remain open |

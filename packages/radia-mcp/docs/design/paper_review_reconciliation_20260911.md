...
The DOI request-lifecycle follow-up adds 14 offline cases; the five-file lane
passes 809 tests. Crossref responses close on success, HTTP errors, JSON failures
and malformed payloads. IEEE DOI resolution closes both its response and owned
session, including request/URL-read exceptions. Crossref 404 remains not_found;
403/429/503 and invalid responses remain temporary failures. Success metadata and

...
Internal cleanup and migration evidence is retained under
validation_test/documentation_maintenance/peec_integration; it is not a
user-facing capability route. Executable verification lives under

...
def load_prompt(subpackage: str, name: str) -> str:
    """Load a markdown prompt from <subpackage>.prompts.

    Args:
        subpackage: fully qualified package name (e.g. "radia_mcp.ih"
                    — dots OK for nested).
...
def list_prompts(subpackage: str) -> List[str]:
    """List all .md prompts in the fully qualified <subpackage>.prompts.

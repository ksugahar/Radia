...
Runnable OCC-native companion (no Cubit dependency):
`validation_test/ngsolve_user_meeting/volume_area_convergence.py`, with durable
numeric results in
`validation_test/ngsolve_user_meeting/volume_area_convergence_results.json`.

...
SOURCE ARCHIVE NOTEBOOK: docs/hdiv_vim/vim_examples_archive.ipynb -- executed inventory of the examples/vim corpus, synchronized with docs/hdiv_vim/vim_examples_archive_results.json (full source + SHA + historical result JSON payloads). The examples stay protected until direct validation_test imports/citations are migrated.

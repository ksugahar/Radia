...
The MCP server exposes this via magnetostatic_2d_parity_documentation(topic=...). Topics:
...
``validation_test/radia_mcp/test_magnetostatic_2d_xcheck_kelvin_magnet.py`` loads a stored Kelvin-transform
...
| test_magnetostatic_2d_xcheck_kelvin_magnet      | stored open-bdry ref B_z(r=7)     |  0.78% |
...
def get_magnetostatic_2d_parity_documentation(topic: str = "all") -> str:
    ...
    raise ValueError(f"Unknown magnetostatic_2d_parity topic '{topic}'. "

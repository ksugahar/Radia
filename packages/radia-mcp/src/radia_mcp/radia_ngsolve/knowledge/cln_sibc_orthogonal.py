...
Phase 3 of the β-1 benchmark (`validation_test/hiruma_xfem_comparison/`)
verified that:
...
|--------|----------------|--------|
| Hiruma XFEM ψ = exp(-γξ) on cylinder | the phase2 section of `validation_test/hiruma_xfem_comparison/hiruma_xfem_comparison.ipynb` (NGSolve compound H1×H1 + manual product-rule grad + bonus_intorder=10) | ✓ 0.14% at r/δ=15, 88 DOF |
| Augmented CLN Galerkin-Krylov | the phase3b section of `validation_test/hiruma_xfem_comparison/hiruma_xfem_comparison.ipynb` | ✓ d = 4.78×10⁴ rad/s (4% from analytical wall band); ✗ r(f) → 1 fails for volume-source |
...
## References
  ...
  - β-1 Phase 1-3 benchmark (2026-05-25):
      validation_test/hiruma_xfem_comparison/hiruma_xfem_comparison.ipynb

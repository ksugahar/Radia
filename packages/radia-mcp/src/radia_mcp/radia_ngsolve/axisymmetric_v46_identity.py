...
def validate_public_identity(identity: object) -> dict[str, bool]:
    ...
    if isinstance(force, Mapping):
        checks["magnetostatic_2d_v46_force_generation_closure"] = _closed(
            force,
            ("force_generation", "contour_generation", "open_boundary_generation", "solve_generation", "result_generation"),
        )
        checks["magnetostatic_2d_v46_force_method_boundary_state"] = (
        ...
        checks["magnetostatic_2d_v46_force_values_owner_digest"] = (
    ...
    if isinstance(nonlinear, Mapping):
        checks["magnetostatic_2d_v46_bh_generation_closure"] = _closed(
            nonlinear,
            ("bh_curve_generation", "unit_generation", "convergence_generation", "result_generation"),
        )
        points = nonlinear.get("bh_points")
        checks["magnetostatic_2d_v46_bh_units_convergence_finite"] = (
        ...
        checks["magnetostatic_2d_v46_bh_owner_digest"] = (
...
def validate_source_identity(identity: object) -> dict[str, bool]:
    ...
    if isinstance(problem, Mapping):
        checks["magnetostatic_2d_v46_source_problem_generation_closure"] = _closed(
            problem,
        ...
        checks["magnetostatic_2d_v46_source_problem_replay"] = (
        ...
        checks["magnetostatic_2d_v46_source_problem_owner_digest"] = (
    ...
    if isinstance(stress, Mapping):
        checks["magnetostatic_2d_v46_source_stress_generation_closure"] = _closed(
            stress,
            ("weighted_stress_generation", "contour_sampling_generation", "partial_solution_generation", "owner_generation", "result_generation"),
        )
        checks["magnetostatic_2d_v46_source_stress_sampling_solution"] = (
        ...
        checks["magnetostatic_2d_v46_source_stress_owner_digest"] = (

...
Use the official MATLAB MCP Server as the MATLAB execution substrate:
...
Do not replace this layer with a Sugahara-specific MATLAB bridge. Lab tools and
skills add domain knowledge above the official server: `.vol` IO, P1 FEM/BEM

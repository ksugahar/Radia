...
uses direct pinned `optuna==5.0.0`, because the verified upstream MCP sampler
...
direct pinned `optuna==5.0.0`; the public MCP contract is regenerated through
...
`matlab_optuna_compatibility_contract` for the checked Optuna 5.0.0

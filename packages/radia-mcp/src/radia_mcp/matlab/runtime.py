    ...
    return {
        ...
        "cad_topology_optimization": {
            ...
            "sheet_metal": {
                ...
                "matlab_api": ["radia.topopt.localTrustRegion", "radia.topopt.solveSheetMetalLP", "radia.topopt.acceptTrafoStep", "radia.topopt.routeMeshUpdate"],
                "mcp_tool": "matlab_sheet_metal_topology_build",
                "continuity_policy": "Design fields remain mesh-independent; refinement is performed only between accepted LP iterations and fields are prolonged/reprojected before reapplying deformation",

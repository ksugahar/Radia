...
def matlab_radia_mex_contract(topic="all"):
    ...
    base = {
        ...
        "limitations": [
            ...
            "MATLAB Optuna is a versioned, differentially verified subset of Optuna 4.9.0, not a drop-in replacement for the complete Python package; query matlab_optuna_compatibility_contract for verified behavior and explicit gaps.",
...
def matlab_optuna_simulink_contract():
    """Return the MATLAB Optuna 4.9 differential-subset and Simulink contract."""
    ...
    return {
        ...
        "sampler_quality": {
            ...
            "python_parity_claim": "supported shared behavior is fixture-checked against pinned Optuna 4.9.0; parallel scheduling and MATLAB persistence remain integration-only",
        ...
        "python_relation": "The official Optuna MCP remains the external owner for generic Python Optuna. MATLAB-native samplers do not call Python per trial; exact GPSampler Backend='upstream-python' intentionally uses the pinned in-process Optuna 4.9.0 runtime.",

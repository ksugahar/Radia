...
def matlab_optuna_simulink_contract():
    ...
    return {
        ...
        "simulink_blocks": [
            ...
            "Optimization/Optuna Optimization operates an OptimizationSession one trial per block sample; start/cancel/pause/resume/apply are independent edge commands, completed history is checkpointed, a completed or Pareto trial can be selected and applied, and selected/pruned/current/checkpoint telemetry extends the original fourteen outputs without reordering them.",

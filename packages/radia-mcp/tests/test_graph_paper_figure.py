"""Golden tests for radia_mcp.graph.paper_figure (v0.78.0).
...
from radia_mcp.graph import (  # noqa: E402
    PROFILES,
    PaperProfile,
    OKABE_ITO,
    paper_figure,
...
def test_auto_tighten_no_new_clipping():
    ...
    fig, axes = paper_figure("ieee_double_column", nrows=1, ncols=2)
    _populate(axes)
    from radia_mcp.graph._paper_figure import _compute_overhang_px

...
def _artifact_identity(sample_count):
    return {
        ...
        "circuit_current_peak_rms_phasor_phase_generation_identity": {
            "circuit_generation": "circuit-20",
            "field_response_circuit_generation": "circuit-20",
            "phasor_generation": "phasor-20",
            "circuit_current_phasor_generation": "phasor-20",
            "field_response_phasor_generation": "phasor-20",
            "current_amplitude_convention": "rms",
            "field_response_amplitude_convention": "rms",
            "current_amplitude_a": 10.0,
            "field_response_current_amplitude_a": 10.0,
            "phase_unit": "deg",
            "field_response_phase_unit": "deg",
            "phase_value": 30.0,
            "field_response_phase_value": 30.0,
            "current_phasor_sha256": "1" * 64,
            "field_response_current_phasor_sha256": "1" * 64,
        },
        "incremental_permeability_bh_operating_point_iteration_identity": {
            "nonlinear_solve_generation": "nonlinear-solve-20",
            "operating_point_solve_generation": "nonlinear-solve-20",
            "incremental_permeability_solve_generation": "nonlinear-solve-20",
            "force_sensitivity_solve_generation": "nonlinear-solve-20",
            "operating_point_iteration_generation": "iteration-20",
            "incremental_permeability_iteration_generation": "iteration-20",
            "force_sensitivity_iteration_generation": "iteration-20",
            "operating_point_iteration": 12,
            "incremental_permeability_iteration": 12,
            "force_sensitivity_iteration": 12,
            "operating_point_b_t": [1.2, 1.35],
            "incremental_permeability_b_t": [1.2, 1.35],
            "operating_point_sha256": "2" * 64,
            "incremental_permeability_operating_point_sha256": "2" * 64,
            "force_sensitivity_operating_point_sha256": "2" * 64,
        },
    }

...
def _with_artifact_identity(payload: dict) -> dict:
    payload["artifact_identity"] = {
        ...
        "skew_slice_torque_mechanical_phase_offset_generation_identity": {
            "torque_average_generation": "skew-average-20",
            "slice_torque_average_generation": "skew-average-20",
            "slice_geometry_generation": "skew-geometry-20",
            "phase_offset_slice_geometry_generation": "skew-geometry-20",
            "torque_waveform_slice_geometry_generation": "skew-geometry-20",
            "slice_ids": [1, 2, 3],
            "phase_offset_slice_ids": [1, 2, 3],
            "mechanical_phase_offsets_deg": [-2.0, 0.0, 2.0],
            "applied_mechanical_phase_offsets_deg": [-2.0, 0.0, 2.0],
            "slice_torque_waveform_sha256": ["1" * 64, "2" * 64, "3" * 64],
            "averaged_slice_torque_waveform_sha256": [
                "1" * 64,
                "2" * 64,
                "3" * 64,
            ],
            "phase_offset_map_sha256": "4" * 64,
            "applied_phase_offset_map_sha256": "4" * 64,
        },
        "winding_phase_belt_slot_numbering_sequence_generation_identity": {
            "winding_generation": "winding-20",
            "phase_belt_winding_generation": "winding-20",
            "mmf_harmonic_winding_generation": "winding-20",
            "slot_numbering_generation": "slot-numbering-20",
            "phase_belt_slot_numbering_generation": "slot-numbering-20",
            "mmf_slot_numbering_generation": "slot-numbering-20",
            "slot_numbers": [1, 2, 3, 4, 5, 6],
            "phase_belt_slot_numbers": [1, 2, 3, 4, 5, 6],
            "phase_sequence": ["A+", "C-", "B+", "A-", "C+", "B-"],
            "mmf_phase_sequence": ["A+", "C-", "B+", "A-", "C+", "B-"],
            "slot_phase_map_sha256": "5" * 64,
            "mmf_slot_phase_map_sha256": "5" * 64,
        },
    }
    return payload

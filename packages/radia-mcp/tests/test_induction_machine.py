...
@pytest.mark.xval
def test_breakdown_matches_numeric():
...
@pytest.mark.xval
def test_breakdown_torque_is_R2_invariant():
...
if __name__ == "__main__":
    test_thevenin_reduction()
    test_breakdown_matches_numeric()
    test_breakdown_torque_is_R2_invariant()
    test_torque_curve_shape()

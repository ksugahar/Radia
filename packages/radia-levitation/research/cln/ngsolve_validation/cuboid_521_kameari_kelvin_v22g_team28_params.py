...
print("Starting v22g (TEAM 28 params: R=65mm Al, t=3mm) (refined mesh + Order=3)...", flush=True)
...
# === Parameters: TEAM 28 (COMSOL CLN_COMSOL.m) ===
# w0 = 130mm (diameter), h0 = 3mm, sig = 34 MS/m (Aluminum)
R_disk = 65e-3        # 130/2 mm
half_thick = 1.5e-3   # 3 mm full thickness
sigma_Cu = 34e6       # Aluminum conductivity (TEAM 28)
mu0 = 4 * pi * 1e-7
nu0 = 1.0 / mu0

a_kelvin = 325e-3     # 5 × R_disk = 325mm
z_offset = 5 * a_kelvin
maxh = 13e-3          # ~ a_kelvin / 25
maxh_disk = 0.65e-3   # ~ R_disk / 100 (matching ratio of v22b)
ORDER = 3
N_STAGES = 6
B0 = 1.0
...
def main():
    ...
    out_path = Path(__file__).parent / "cuboid_521_kameari_kelvin_v22g_team28_params.json"

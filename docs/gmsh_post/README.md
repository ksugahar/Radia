...
| [`validation_test/gmsh_post/em_fieldlines_results.json`](../../validation_test/gmsh_post/em_fieldlines_results.json) | Checked field-line evidence; the executed notebook owns the public presentation. |
...
| [`validation_test/gmsh_post/em_post_gallery_results.json`](../../validation_test/gmsh_post/em_post_gallery_results.json) | Checked gallery evidence, kept outside the public docs tree. |
...
| [`validation_test/gmsh_post/em_particle_orbits_results.json`](../../validation_test/gmsh_post/em_particle_orbits_results.json) | Checked orbit evidence, kept outside the public docs tree. |

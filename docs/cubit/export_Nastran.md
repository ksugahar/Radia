...
```
export jmag_nastran "mesh.bdf"
export jmag_nastran "mesh.bdf" dimension 2
export jmag_nastran "mesh.bdf" nopyramid
export jmag_nastran "mesh.bdf" dimension 2 nopyramid overwrite
```
...
> **IMPORTANT**: Use `export jmag_nastran`, NOT `export nastran`.
...
cubit.cmd('export jmag_nastran "mesh.bdf" dimension 2 nopyramid overwrite')
```

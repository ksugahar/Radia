...
Section~\ref{sec:basis} describes the KAN-inspired insight and circuit-compatible basis library. Section~\ref{sec:method} presents the training algorithm. Section~\ref{sec:results} provides benchmark results with emphasis on the pole-free advantage and circuit synthesis. Section~\ref{sec:discussion} identifies target applications where URN is most effective. Section~\ref{sec:conclusion} concludes.

...
\textbf{Valid critique}: URN uses fixed basis function \textit{forms} (Debye, Cole-Cole), unlike standard KAN which learns arbitrary spline shapes. This resembles sparse dictionary learning more than classical KAN.
...
\textbf{Open-source availability}: PyTorch implementation (700 lines), CPU-only, training time 100--150 seconds per case. No GPU required. Source code is available at \url{https://github.com/ksugahar/Radia} in the \texttt{examples/peec\_integration/} directory.

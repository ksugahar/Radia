...
\begin{axis}[
    ...
    xlabel={$Z'$ (m$\Omega$)},
    ylabel={$-Z''$ (m$\Omega$)},
    title={\small NASA 18650 Li-ion EIS},
    xmin=0, xmax=400,
    ymin=-200, ymax=250,
    grid=major,
...
\addplot[blue, thick, only marks, mark=o, mark size=1pt] coordinates {
    (130,197) (59,-33) (6,61) (126,90) (221,4) (245,-98)
    (235,-165) (224,-195) (221,-194) (226,-172) (231,-136)
    (230,-93) (222,-51) (207,-14) (188,15) (169,35)
    (151,48) (138,55) (130,58) (126,58) (127,56)
    (133,52) (141,45) (152,34) (164,21) (175,5)
    (185,-14) (192,-32) (197,-50) (200,-65) (202,-75)
    (203,-79) (204,-77) (204,-68) (204,-52) (201,-32)
    (195,-7) (186,18) (174,42) (162,64) (152,82)
    (150,97) (160,109) (190,113) (246,95) (327,18) (377,-176)
};
\node[font=\tiny] at (axis cs:50,220) {0.1 Hz};
\node[font=\tiny] at (axis cs:350,-150) {5 kHz};
\end{axis}
\end{tikzpicture}
\hfill
\begin{tikzpicture}
...
\addplot[red, thick, only marks, mark=square, mark size=1pt] coordinates {
    (10000,6.76) (20000,13.51) (50000,33.30) (100000,65.26)
    (200000,124.75) (300000,176.26) (500000,259.02)
    (700000,320.95) (1000000,401.65) (2000000,537.69)
    (3000000,576.88) (5000000,550.19) (7000000,524.38) (10000000,497.40)
};
\end{axis}
\end{tikzpicture}
\caption{Real-world EIS data used for URN validation. Left: NASA 18650 Li-ion battery showing semicircle (charge transfer) and Warburg tail (diffusion). Right: TDK PC50 MnZn ferrite showing frequency-dependent impedance with Cole-Cole relaxation peak near 3 MHz.}
...
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Dataset} & \textbf{VF NRMSE} & \textbf{URN NRMSE} & \textbf{Improvement} & \textbf{Time} \\
\midrule
NASA 18650 Battery & 0.2700 & \textbf{0.2454} & 9.1\% & 178s \\
TDK PC47 Ferrite & 0.0146 & \textbf{0.0088} & 39.4\% & 175s \\
TDK PC50 Ferrite & 0.0288 & \textbf{0.0098} & 65.9\% & 176s \\
TDK PC95 Ferrite & \textbf{0.0080} & 0.0120 & $-$48.9\% & 176s \\
TDK PC200 Ferrite & 0.0108 & \textbf{0.0056} & 48.4\% & 177s \\
\midrule
\textbf{Average} & --- & --- & \textbf{22.8\%} & 176s \\
\bottomrule
\end{tabular}
\begin{flushleft}
...
The validation script \texttt{validate\_urn\_vs\_vf.py} and generated SPICE netlists are included in the repository.

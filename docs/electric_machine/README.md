...
| [`validation_test/electric_machine/cogging_skew_demo_results.json`](../../validation_test/electric_machine/cogging_skew_demo_results.json) | Checked torque, skew, and runtime evidence. |

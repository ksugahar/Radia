...
`examples/axifemm/research/codegen_q2_henrotte.py`).
...
`examples/axifemm/research/codegen_q_heat_henrotte.py` (or its
...
3. **Independent BEM-Foster reference** — the Cauer ladder time
   ...
   `examples/axifemm/research/verification/test_3way_cauer_cross_validation.py`

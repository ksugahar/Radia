...
- [`validation_test/documentation_maintenance/induction_heating/induction_heating_demo_showcase.ipynb`](../../validation_test/documentation_maintenance/induction_heating/induction_heating_demo_showcase.ipynb) — result-saved public ESIM/WPT/RWG demo showcase.

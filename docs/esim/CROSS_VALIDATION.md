...
**Implementation.**  [`validation_test/ih_esim_benchmark/analytical_bessel_baseline.py`](../../validation_test/ih_esim_benchmark/analytical_bessel_baseline.py)
computes `Z_s^anal` over a frequency sweep.
[`validation_test/ih_esim_benchmark/benchmark.py`](../../validation_test/ih_esim_benchmark/benchmark.py)
...
[`results.json`](../../validation_test/ih_esim_benchmark/results.json):
...
source of truth is
`validation_test/ih_esim_benchmark/sweep_data_dense/`, a 9-current x
...
(From `validation_test/ih_esim_benchmark/sweep_data_dense/I100_f50k_{scalar,per_panel}.json`.)
...
generated by `validation_test/ih_esim_benchmark/sweep_f_I.py` + matching
`plot_digest_figure.py`; see that example's
[`README.md` "Phase B" section](../../validation_test/ih_esim_benchmark/README.md#phase-b-per-element-vs-scalar-disagreement-sweep-sweep_f_ipy)
...
point.  Runner:
[`validation_test/ih_esim_benchmark/sweep_f_I.py`](../../validation_test/ih_esim_benchmark/sweep_f_I.py).
Figure source: [`sweep_data_dense/`](../../validation_test/ih_esim_benchmark/sweep_data_dense/).
...
Excerpted from [`results.json`](../../validation_test/ih_esim_benchmark/results.json)
...
([`results.json sweep[1].results.fem_kelvin`](../../validation_test/ih_esim_benchmark/results.json)):
...
([`results.json sweep[1].results.fem_coilmesh`](../../validation_test/ih_esim_benchmark/results.json)):

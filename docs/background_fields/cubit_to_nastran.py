...
Requires:
    - Coreform Cubit
    - Radia's Cubit installation discovery helper
"""

import os
import sys

# Auto-detect Cubit without adding repository source directories to sys.path.
...
cubit.cmd(f'export nastran_bdf "{filename}.bdf" dimension 3 nopyramid overwrite')

...
available — `axifem` provides a P1-triangle fallback,
...
special-case stiffness formulas (see `axifem_core.element_matrices`
in `tests/axifem/_reference_python/` for the per-element reference
implementation).

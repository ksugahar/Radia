...
`docs/axifem/legacy_assets/axifem/research/codegen_q2_henrotte.py`).
...
`docs/axifem/legacy_assets/axifem/research/codegen_q_heat_henrotte.py` (or its
...
2. **Mathematica derivation** —
   `validation_test/axifem/research/validate_q2_codegen.py` runs the
...
- runs at FEMM-grade accuracy per DOF, validated against FEMM `.mat`
  ...
  (`docs/axifem/legacy_assets/axifem/nmr_validation/`).

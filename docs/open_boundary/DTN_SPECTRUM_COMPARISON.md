...
**Build decision (Gate 1, routed in [`ARCHIVE_RETIREMENT.md`](../kelvin/ARCHIVE_RETIREMENT.md)).**
...
**Fair re-test on the DtN yardstick (maintained through `src/radia/infinite_element.py`).**

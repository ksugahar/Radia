...
- Revised: 2026-09-04 after the released-binary mixed
...
must not be presented as the current mixed total/reduced-Omega
...
The audited source contains 20 supported `RADIA_HDIV_*` environment controls.
...
merely because it was once called canonical.

...
[`demo_coil_design_gx.py`](../../validation_test/documentation_maintenance/stream_function/examples_catalog.ipynb):
...
### Arbitrary curved formers (sphere) — FE-direct ψ ([`demo_sphere_fe_direct.py`](../../validation_test/documentation_maintenance/stream_function/examples_catalog.ipynb))
...
[`examples_catalog.ipynb`](../../validation_test/documentation_maintenance/stream_function/examples_catalog.ipynb).  Keep new public

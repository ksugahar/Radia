...
| demo | parts |
|------|-------|
| [`demo_regcoil_fusion.py`](demo_regcoil_fusion.py) | forward map  /  REGCOIL L-curve  /  net current  /  VMEC boundary |
| [`demo_regcoil_fusion_advanced.py`](demo_regcoil_fusion_advanced.py) | coil force/stress  /  real li383 wout  /  FOCUS standoff  /  FOCUS winding-shape |
...
The driver for (a) is
[`demo_regcoil_parity_deliverable.py`](../../validation_test/stream_function/demo_regcoil_parity_deliverable.py)

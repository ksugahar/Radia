...
| demo | parts |
|------|-------|
| [`demo_regcoil_fusion.py`](../../validation_test/documentation_maintenance/stream_function/examples_catalog.ipynb) | forward map  /  REGCOIL L-curve  /  net current  /  VMEC boundary |
| [`demo_regcoil_fusion_advanced.py`](../../validation_test/documentation_maintenance/stream_function/examples_catalog.ipynb) | coil force/stress  /  real li383 wout  /  FOCUS standoff  /  FOCUS winding-shape |
...
The driver for (a) is
[`demo_regcoil_parity_deliverable.py`](../../validation_test/documentation_maintenance/stream_function/examples_catalog.ipynb)

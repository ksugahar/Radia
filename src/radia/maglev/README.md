...
| `examples/maglev/research_cln/axifem/` | Historical Henrotte-basis axifem prototype corpus; promoted user-facing artifacts now live under `docs/axifem/legacy_assets/axifem/` and `docs/axifem/` |

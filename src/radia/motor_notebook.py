...
MOTOR_FIELD_SPECS = (
    ...
    NotebookFieldSpec("stack_length", "stack length", section="Geometry"),
    NotebookFieldSpec("n_pole_pairs", "pole pairs", "int", section="Transient"),
    NotebookFieldSpec("r_airgap_mid", "airgap r", section="Geometry"),
    ...
    NotebookFieldSpec("mu_r_iron", "mu_r iron", section="Material"),
    ...
    NotebookFieldSpec("h_amplitude", "H amp", section="Excitation"),
    NotebookFieldSpec("freq", "freq", section="Lamination"),
    NotebookFieldSpec("field_angle_deg", "field angle [deg]", section="HDiv Reduced"),
    NotebookFieldSpec("rotor_angle_start_deg", "rotor start [deg]", section="HDiv Reduced"),
    NotebookFieldSpec("rotor_angle_stop_deg", "rotor stop [deg]", section="HDiv Reduced"),
    NotebookFieldSpec("rotor_angle_steps", "angle steps", "int", section="HDiv Reduced"),
    NotebookFieldSpec("energy_delta_deg", "energy delta [deg]", section="HDiv Reduced"),

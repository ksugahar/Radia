...
Radia interface components -- Cubit-side ``register_toolbar.py``, Simulink
...
goes wrong in the Cubit toolbar, Simulink application, or calc subprocess:

  - Did the Cubit toolbar or Simulink application initialize?

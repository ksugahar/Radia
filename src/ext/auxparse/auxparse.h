...
//-------------------------------------------------------------------------
// CAuxBinStr base class + operator<<,>> templates REMOVED (Phase B3, 2026-04-16)
// Previously used by CAuxBinStrVect (gmvbstr.h, also removed) for the
// per-class DumpBin / DumpBinParse binary serialization layer.
//-------------------------------------------------------------------------

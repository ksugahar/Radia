...
// Reference: ELF-style optimization (same as RadHACApKManager::PrecomputeGeometry3DOF)
//=========================================================================
...
// Reference: ELF-style optimization (same as RadHACApKManager::Compute3x3BlockFast)
//=========================================================================
...
int radTInteraction::SetIMASymmetry(int symmetry, int signX, int signY, int signZ)
{
	...
	std::cout << "[Radia] IMA symmetry enabled: " << m_imaNumElements
	          << " / " << AmOfMainElem << " elements in IMA region";
	if(numVirtualMirrors > 0)
	{
		std::cout << " (" << numVirtualMirrors << " use virtual mirrors)";
	}
	std::cout << std::endl;

"""Compatibility import for the former ``spice_circuit_lab`` package.
...
from radia.ltspice.filter_gates import sallen_key_filter_family_gate

__all__ = [*_impl.__all__, "sallen_key_filter_family_gate"]
